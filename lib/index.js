...
// return Promise
Crowdin.prototype.fileUpload = function(uri, path) {
...
// return Promise
Crowdin.prototype.addFile = function(path) {
    return this.fileUpload('add-file', path);
};

// return Promise
Crowdin.prototype.updateFile = function(path) {
    return this.fileUpload('update-file', path);
};
